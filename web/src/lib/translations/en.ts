...
export const en = {
  ...
  hero: {
    ...
    subtitle: "Premium gym apparel, accessories and supplements designed for athletes who demand more.",
    cta: "Shop Collection",
  },
  ...
  categories: {
    ...
    subtitle: "Calibrated Athletic Systems",
    apparel: "Gym Apparel",
    supplements: "Supplements",
    liftingAccessories: "Lifting Accessories",
    newArrivals: "New Arrivals",
    apparelDesc: "Engineered high-tension fabrics",
    supplementsDesc: "Purity-tested compound nutrition",
    accessoriesDesc: "10mm leverage bracing & supports",
    newArrivalsDesc: "Next generation launch batch",
  },

  // Best Sellers Section
  bestSellers: {
    title: "Best Sellers",
    subtitle: "Battle-Tested Performance Gear",
    viewAll: "View All",
  ...
  features: {
    ...
    subtitle: "Engineered to push human limits under structural stress",
    f1Title: "Premium Heavyweight Build",
    f1Desc: "240GSM combed cotton and double stitched seams built to withstand intense training friction.",
    f2Title: "Intra-Abdominal Bracing",
    f2Desc: "10mm thick genuine cowhide leather providing elite lumbar spine structural integrity.",
    f3Title: "Dry-Core Ventilation",
    f3Desc: "Hydrophobic dry-wicking synthetics crafted for complete moisture and thermal balance.",
  },

  // Newsletter Section
  newsletter: {
    title: "Join The Performance Registry",
    subtitle: "Subscribe to receive direct lab updates, premium limited SKU drops, and training protocols.",
    emailPlaceholder: "Enter your active athletic email address...",
    subscribe: "Subscribe",
    subscribing: "Subscribing...",
    successToast: "Successfully subscribed! Welcome to the elite roster.",
    invalidEmail: "Please enter a valid active email address.",
  },

  // Footer Section
  footer: {
    tagline: "Henry Fit - Elite high performance tactical sports gear.",
    quickLinks: "Expert Links",
    support: "Support",
    legal: "Legal Info",
    aboutUs: "About Us",
    contact: "Contact",
  ...
  // Contact Form
  contactForm: {
    title: "CONTACT THE PERFORMANCE LAB",
    subtitle: "Direct performance inquiries, custom team orders, or high tensile gear concerns.",
    name: "Full Name",
    namePlaceholder: "Enter your full name...",
    email: "Active Email Address",
    emailPlaceholder: "Enter your active email...",
    message: "Consultation Message",
    messagePlaceholder: "Specify your training goals, sports discipline, or equipment inquiry...",
    submit: "Submit Inquiries",
    submitting: "Submitting Inquiry...",
    success: "Inquiry received. A performance specialist will contact you shortly.",
    errName: "Name is required.",
    errEmail: "Please provide a valid active email address.",
    errMessage: "Please specify your inquiry description.",
  },
  ...
  // Toast Alerts
  toasts: {
    addedToCart: "Successfully added to your active configuration!",
    removedFromCart: "Successfully removed item from cart.",
    cartCleared: "Active setup cart cleared completely.",
    quantityUpdated: "Quantity updated successfully.",
  },

  // Static Pages
  about: {
    title: "ABOUT HENRY FIT LABS",
    sub: "CO-ENGINEERED WITH ELITE POWERLIFTERS, HYBRID ATHLETES, AND BIOMECHANICAL SPECIALISTS.",
    p1: "At Henry Fit, we believe that your training gear should be as uncompromising as your work ethic. Traditional athletic wear compromises on tensile durability, density, and fit context. We founded Henry Fit to correct those gaps.",
    p2: "Every oversized tee, compression weave, and 10mm genuine leather powerlifting belt is engineered for complete structural synergy. There are no decorative lines—only reinforced stitches, anatomically targeted dry-mesh panels, and high-tensile cowhide leather cores.",
  },

  shipping: {
    title: "SHIPPING & DELIVERY CODES",
    sub: "GLOBAL HIGH-SPEED COLD-CHAIN DISPATCH PROTOCOLS",
    p1: "Our fulfillment centers operate 24/7. Once an order signature is authenticated, your training payload is hand-packed and dispatched within 12-24 hours. Tracking identifiers are transmitted instantly to your active registry email.",
    p2: "Express Shipping: 2-3 standard training days. Standard Priority: 5-7 business days. Fully secured and insured against transit abrasion and package displacement.",
  },

  privacy: {
    title: "PRIVACY POLICY REGISTRY",
    sub: "SECURE IDENTITY & TRANSACT DATA ENCRYPTION",
    p1: "Your active telemetry and banking credentials are standard protected with military-grade AES-256 secure encryption protocols. We NEVER distribute, publish, or monetize your personalized training goals, names, static metrics, or physical addresses.",
    p2: "We only retain logs necessary to sustain stable user sessions, authenticate order checkouts, and transmit Gemini-calibrated AI performance recommendations requested directly by your browser.",
  },

  terms: {
    title: "TERMS OF SERVICE STATEMENTS",
    sub: "REGISTRY AGREEMENT & ATHLETIC RESPONSIBILITIES",
    p1: "By navigating our shop, purchasing heavy compound instruments (lifting belts, tools), or consulting our AI Specialist Agent, you certify that you have consulted active practitioners for physical training guidance.",
    p2: "Henry Fit is not liable for structural muscle failure, hyperextension, or training fatigue caused by loaded exercise. Load plates at your own biomechanical discretion.",
  }
};
